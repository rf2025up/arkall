...
exports.checkLegacyDatabase = checkLegacyDatabase;
exports.performLegacyMigration = performLegacyMigration;
...
// 检查遗留数据库
async function checkLegacyDatabase() {
    try {
        // 尝试连接到arkok数据库检查遗留表
        const legacyPrisma = new client_1.PrismaClient({
            datasources: {
                db: {
    ...
    `;
      ...
      `;
        ...
        console.log('ℹ️  无法连接到遗留数据库:', error.message);
        return false;
    }
}
// 执行遗留数据迁移
...
//# sourceMappingURL=migrate_legacy.js.map